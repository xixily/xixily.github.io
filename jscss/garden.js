function f_brokenheart(e) {
	...
	var s;
	for (s = t; s < n; s += .001) {
		var o = 17 * Math.pow(s, 2) - 16 * Math.abs(s) * e + 17
				* Math.pow(e, 2) + 350 / Math.abs(5 * s + Math.sin(5 * e)) < 225;
		if (i ^ o) {
			r.push(s)
		}
		i = o
...
function startHeartAnimation() {
	...
	var i = setInterval(function() {
		...
		for (var n = 0; n < e.length; n++) {
			garden.createRandomBloom(e[n] * 70 + offsetX, -r * 70 + offsetY
					+ 50)
		}
		if (r > t) {
			clearInterval(i);
...
function timeElapse(e) {
	...
	var o = '    <span class="digit">' + r
			+ '</span> 天 <span class="digit">' + i
			+ '</span> 小时 <span class="digit"><br/>  ' + s
			+ '</span> 分 <span class="digit">' + n + "</span> 秒";
	$("#elapseClock").html(o)
}
	...
	init : function() {
		...
		for (var n = 0; n < this.pc; n++) {
			this.petals.push(new Petal(Garden.random(
					...
					Garden.options.petalStretch.min,
					Garden.options.petalStretch.max), t + n * e, e, Garden
...
Garden.prototype = {
	...
	createRandomBloom : function(e, t) {
		this.createBloom(e, t, Garden.randomInt(Garden.options.bloomRadius.min,
